<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMP.Master" AutoEventWireup="true" CodeBehind="AddPlate.aspx.cs" Inherits="UserInterface.Administrator.AddPlate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <asp:Button ID="btnAddPlate" runat="server" Text="Agregar" class="btn btn-success" OnClick="btnAddPlate_Click"/>
        </div>
    </div>
