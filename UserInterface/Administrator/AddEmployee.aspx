<%@ Page Title="" Language="C#" MasterPageFile="~/Administrator/AdminMP.Master" AutoEventWireup="true" CodeBehind="AddEmployee.aspx.cs" Inherits="UserInterface.Administrator.AddEmployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <asp:DropDownList ID="ddlJob" runat="server" Width="200px">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <asp:Button ID="btnAddEmployee" runat="server" Text="Agregar" class="btn btn-success" OnClick="btnAddEmployee_Click"/>
        </div>
    </div>
</asp:Content>
